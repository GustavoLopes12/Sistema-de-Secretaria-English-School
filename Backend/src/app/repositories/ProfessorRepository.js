...
class ProfessorRepository{
    findAll(){
        ...
        const msgError = "Não foi possível localizar os professores";//POR ERRO NO SQL OU INTERNO
        return consulta(sql, msgError);
    }
    findById(registro){
        const sql = "SELECT * FROM professores WHERE registro = ?";
        const msgError = "Não foi possível achar o professor requerido";//POR ERRO NO SQL OU INTERNO
